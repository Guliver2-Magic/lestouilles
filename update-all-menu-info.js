// This script adds quantity, nutrition, and ensures servings are present for all menu items
const fs = require('fs');

const menuFile = './client/src/data/completeMenuData.ts';
let content = fs.readFileSync(menuFile, 'utf8');

// Define nutrition and quantity by category
const categoryDefaults = {
  ...
  'Traiteur - Buffets': { quantity: '10-12 personnes', nutrition: { calories: 520, protein: 28, carbs: 45, fat: 24 } },
...
console.log('Menu nutrition update script ready');
console.log('Categories:', Object.keys(categoryDefaults));
